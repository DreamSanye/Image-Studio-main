...
type Options struct {
	...
	// ImagesAsyncPolling toggles relays that return a task id first and require
	// GET /v1/images/{task_id} polling for the final image.
	ImagesAsyncPolling bool
	...
	TextModelID  string
	ImageModelID string
	// AllowInsecureHTTP permits non-loopback http:// BaseURL values. Prefer
	// HTTPS in production; this is for trusted LAN / relay compatibility only.
