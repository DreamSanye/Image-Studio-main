  ...
  return {
    async createProfile(input: {
      ...
      const profile: UpstreamProfile = {
        ...
        imagesAsyncPolling: input.imagesAsyncPolling === true,
    ...
    async updateProfile(id: string, patch: Partial<Omit<UpstreamProfile, "id" | "createdAt">> & { apiKey?: string }) {
      ...
      const next: UpstreamProfile = {
        ...
        imagesAsyncPolling: patch.imagesAsyncPolling ?? current.imagesAsyncPolling ?? false,
        allowInsecureHTTP: patch.allowInsecureHTTP ?? current.allowInsecureHTTP ?? false,
      ...
      if (id === store.getState().activeProfileId) {
        ...
        store.setState({
          ...
          imagesAsyncPolling: next.imagesAsyncPolling ?? false,
          allowInsecureHTTP: next.allowInsecureHTTP ?? false,
    ...
    async setActiveProfile(id: string) {
      ...
      store.setState({
        ...
        imagesAsyncPolling: profile.imagesAsyncPolling ?? false,
        allowInsecureHTTP: profile.allowInsecureHTTP ?? false,
