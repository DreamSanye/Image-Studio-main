...
function toProfileSnapshot(input: UpstreamConfigExportProfile, actualId: string): UpstreamProfile {
  return {
    ...
    imagesAsyncPolling: input.imagesAsyncPolling,
...
function parseExportProfile(raw: unknown): UpstreamConfigExportProfile | null {
  ...
  return {
    ...
    imagesAsyncPolling: source.imagesAsyncPolling === true,
...
export function buildUpstreamConfigExportFile(
  ...
  return {
    ...
    profiles: profiles.map((profile) => ({
      ...
      imagesAsyncPolling: profile.imagesAsyncPolling === true,
...
function buildProfilePatch(
  ...
  return {
    ...
    imagesAsyncPolling: incoming.imagesAsyncPolling,
